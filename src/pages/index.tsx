  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless journeys with Car Sharing Application - your partner for convenient and eco-friendly travel solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless journeys with Car Sharing Application - your partner for convenient and eco-friendly travel solutions.`}
            </Text>
            <Box
